    ...
    >
      <div className="text-center max-w-3xl">
        <img
          ...
          className="w-32 h-32 md:w-40 md:h-40 rounded-full mx-auto mb-8 shadow-xl object-cover"
          style={{ border: `4px solid ${theme.border}` }}
        />
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold">
          <span style={{ color: theme.blue }}>{userProfile.name}</span>
        </h1>
        <p className="mt-4 text-xl sm:text-2xl" style={{ color: theme.fg }}>
          {userProfile.tagline}
        </p>
        <p className="mt-2 text-md sm:text-lg" style={{ color: theme.muted }}>
